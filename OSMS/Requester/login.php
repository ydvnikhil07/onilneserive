...
if (!isset($_SESSION['is_login'])) {
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT r_name, r_email FROM user WHERE r_email='$remail' AND r_password='$rpassword' LIMIT 1";
...
<body>
    ...
    <p class="text-center" style="font-size: 20px;">
        <i class="fas fa-user-secret text-danger"></i> Requester
    </p>
            ...
            <div class="col-sm-6 col-md-4 mt-4">
                <form action="" class="shadow-lg p-4" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" placeholder="Enter your password" name="rpassword" required>
                    </div>
